...
public class ResourceDetails extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView resourceTitleDetails = (TextView) findViewById(R.id.resourceTitleDetails);
        String resourceTitleStr = getIntent().getStringExtra("resourceTitle");
        resourceTitleDetails.setText(resourceTitleStr);
    }
